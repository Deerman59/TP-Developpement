...
def Jouer():
    ...
    while running:
        ...
        if (toad_x <= 45 or toad_x >= width - 45 - Toad.taille) and Toad_spawn == True and is_jumping_T == False:
            Toad.direction *= -1
        ...
        texteViesBoss = police.render(f"Boss", True, (255, 255, 255))
        texteViesJoueur = police.render(f"Joueur", True, (255, 255, 255))
