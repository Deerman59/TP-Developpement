...
Boss_song_jump_S = 'Sons/RIOMA jump sound mario négatif.wav'
Bowser_song_jump_S = 'Sons/RIOMA jump sound bowser.wav'
GoombaKoopa_song_jump_S = 'Sons/RIOMA jump sound parakoopa goomba.wav'
Boo_song_jump_S = 'Sons/boo sound.wav'
...
pygame.mixer.Sound.set_volume(Boss_song_jump, 0.3)
pygame.mixer.Sound.set_volume(Boo_song_jump, 0.5)
pygame.mixer.Sound.set_volume(Bowser_song_jump, 0.5)
pygame.mixer.Sound.set_volume(GoombaKoopa_song_jump, 0.5)
...
# Redimensionner les images (facultatif)
...
def afficher_menu_volume():
    ...
    while menu_running:
        ...
        texte_surface = font.render(texte_volume, True, WHITE)
