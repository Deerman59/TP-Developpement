...
class Joueur:
    def __init__(self,choix="",vie=0,nom="",taille=0,speed=0,jump=0,imgD="",imgDH="",imgG="",imgGH="",gravity=0.5):
        self.choix = choix
        self.vie = vie
        self.nom = nom
        self.taille = taille
    ...
    def perso(self):
        if self.choix == "Goomba":
            ...
            self.speed = 5
            self.jump = 13
            self.imgD = Goomba_img
            self.imgG = Goomba_img
            self.imgDH = Goomba_img
            self.imgGH = Goomba_img
            self.gravity = 0.5
        if self.choix == "Koopa":
            self.vie = 3
            self.nom = "Para-Koopa"
...
class Boss:
    def __init__(self,vie=5,nom="Mario",taille=90,speed=5,jump=13,direction=-1,gravity=0.5):
        self.vie = vie
        self.nom = nom
        self.taille = taille
        self.speed = speed
...
def Jouer():
    ...
    while running:
        ...
        if boss_y >= height - Boss.taille - platform_height+10:
            boss_y = height - Boss.taille - platform_height+10
            is_jumping_B = False
